...
```bash
# Using Yarn
yarn add @nx-playground/modal-ui-js

# Using NPM.
npm install @nx-playground/modal-ui-js
```
...
import { setupModal } from "@nx-playground/modal-ui-js";
...
@import "~@nx-playground/modal-ui-js/styles.css";
```
