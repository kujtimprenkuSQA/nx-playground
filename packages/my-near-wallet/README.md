...
```bash
# Using Yarn
yarn add @nx-playground/my-near-wallet

# Using NPM.
npm install @nx-playground/my-near-wallet
```
...
import { setupMyNearWallet } from "@nx-playground/my-near-wallet";
...
```ts
import { setupMyNearWallet } from "@nx-playground/my-near-wallet";
import myNearWalletIconUrl from "@nx-playground/my-near-wallet/assets/my-near-wallet-icon.png";
